...
function changeWeatherImage () {
    if (status == "clear sky"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/clearSky.jpg";
    }
    else if (status == "few clouds"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/fewClouds.jpg";
    } 
    else if (status == "scattered clouds"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/scatteredClouds.jpg";
    } 
    else if (status == "broken clouds"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/brokenClouds.jpg";
    } 
    else if (status == "shower rain"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/showerRain.jpg";
    } 
    else if (status == "rain"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/rain.jpg";
    } 
    else if (status == "thunderstorm"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/thunderstorm.jpg";
    } 
    else if (status == "snow"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/snow.jpg";
    } 
    else if (status == "mist"){
        document.getElementById("weather-image").src = "http://amjadmajed.me/weatherMachine/images/mist.jpg";
    } 
}
